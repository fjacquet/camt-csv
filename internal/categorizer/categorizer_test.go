...
func TestCategorizer_CategorizeTransaction(t *testing.T) {
	...
	categorizerInstance := categorizer.NewCategorizer(mockAIClient, mockAIClient, mockStore, logging.NewLogrusAdapterFromLogger(logger), true, 0.70)
...
UBER: "Transport"`
	...
	cat := categorizer.NewCategorizer(mockAIClient, mockAIClient, categoryStore, logging.NewLogrusAdapterFromLogger(logger), true, 0.70)
...
func TestCategorizer_StrategyErrorHandling(t *testing.T) {
	...
	cat := categorizer.NewCategorizer(failingAIClient, failingAIClient, emptyStore, logging.NewLogrusAdapterFromLogger(logger), true, 0.70)
