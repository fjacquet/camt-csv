...
func TestProcessFileWithError_ValidationError(t *testing.T) {
	...
	err := common.ProcessFileWithError(mockParser, "input.xml", "output.csv", true, logger)
...
func TestProcessFileWithError_NoValidation(t *testing.T) {
	...
	err := common.ProcessFileWithError(mockParser, "input.xml", "output.csv", false, logger)
