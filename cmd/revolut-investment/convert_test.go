...
func TestRevolutInvestmentConvert_InvalidFormat(t *testing.T) {
...
func TestRevolutInvestmentConvert_ConversionError(t *testing.T) {
	logger := logging.NewLogrusAdapter("info", "text")
	mockParser := &mockFullParser{
		validateResult: true,
		convertErr:     errors.New("Revolut investment parsing failed"),
	}
